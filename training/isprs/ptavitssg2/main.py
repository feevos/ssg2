...
def train(args):
    ...
    train_dataset = RocksDBDataset_SSG2(                                                                                                    
                 ...
                 #flname_db= '/ZZZZZZ/XXXXX/YYYYYYY/data/isprs/F256/FullTrainSet/train.db', # PAWSEY
    ...
    valid_dataset = RocksDBDataset_SSG2(                                                                                                    
                 ...
                 #flname_db= '/ZZZZZZ/XXXXX/YYYYYYY/data/isprs/F256/FullTrainSet/valid.db', # PAWSEY
                 sequence_length = SequenceLength, 
    ...
    for epoch in range(num_epochs):
        ...
        for i, data in enumerate(train_loader):
            ...
            for idx_seq in range(seq_len):                                                                                                                 
                ...
                tloss = tloss +  mtsk_loss(tpreds,tlabels,criterion,NClasses)                                                                     
            ...
            tloss = tloss + mtsk_loss(preds_target, labels1_wth_off,criterion,NClasses)                                                                
            ...
            tloss = tloss +  criterion_features(features, features2 ).squeeze()
